...
export const VerificationStep: FC<PageProps> = ({ className, disabled = false, animation, inactive = false }) => {
    ...
    return <Step onTransitionDone={onStateChange}
        inactive={inactive}
        disabled={disabled}
        animation={animation}
        className={className}
        onEnter={onSubmit}
        footer={({disabled, inactive}) => <SubmitButton autoFocus={!disabled && !inactive} disabled={disabled} inactive={inactive} className="full-width blue" onClick={onSubmit} />}>
